/*  ------------------- START commented out spring 2015 -------------------
    ...
    monitor.init = function (){
        ...
        if (firstName){ firstName = 'firstName: \'' + firstName + '\',';} else {firstName = '';}
        if (lastName){ lastName = 'lastName: \'' + lastName + '\',';} else {lastName = '';}
        if (department){ department = 'department: \'' + department + '\',';} else {department = '';}
